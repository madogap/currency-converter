...
public class Listings {
    public void showListings(Reader reader) {
        System.out.println("Deseja vê listagem de códigos de moedas? (S/N)");
        try {
            ...
            System.out.println("Erro: Entrada inválida. Certifique-se de inserir S ou N.");
        } catch (Exception e){
